 ...
 */
function digivate_test_customize_register( $wp_customize )
{
    ...
    $wp_customize->selective_refresh->add_partial( 'blogname', array(
        ...
        'render_callback' => 'digivate_test_customize_partial_blogname',
    ) );

    $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
        'selector' => '.site-description',
        'render_callback' => 'digivate_test_customize_partial_blogdescription',
    ) );
...
//        'title' => __( 'Theme Options', 'digivate-test' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
//
//    $wp_customize->add_section( 'post_types', array(
//        'title' => __( 'Post Type Archives', 'digivate-test' ),
//        'priority' => 130, // Before Additional CSS.
//    ) );
...
//            'type' => 'radio',
//            'description' => __('You can make your own layout in header.php and ignore all this.', 'digivate-test'),
//            'choices' => array(
//                'yes' => 'yes',
//                'no' => 'no'
//            )
...
//        array(
//            'label' => __( 'Contain the site top items', 'digivate-test' ),
//            'section' => 'theme_options',
//            'type' => 'select',
//            'choices' => array(
//                'container' => 'contained',
...
//            ),
//            'description' => __('You can set contained size via $container in scss', 'digivate-test')
//        ) );
...
//            'section' => 'theme_options',
//            'type' => 'select',
//            'description' => __('You can make your own layout in php in header.php and ignore presets and manual settings.', 'digivate-test'),
//            'choices' => array(
//                'logo-left' => 'logo-left',
...
add_action( 'customize_register', 'digivate_test_customize_register' );
 ...
 *
 * @since Ignition 1.0
 * @see digivate_test_customize_register()
 *
 * @return void
 */
function digivate_test_customize_partial_blogname()
{
    bloginfo( 'name' );
}
 ...
 * @return void
 */
function digivate_test_customize_partial_blogdescription()
{
 ...
 */
function digivate_test_customize_preview_js()
{
    wp_enqueue_script( 'digivate-test-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js'
    ), array('jquery', 'customize-preview'), '1.0', true );
}

add_action( 'customize_preview_init', 'digivate_test_customize_preview_js' );

/**
 * Load dynamic logic for the customizer controls area.
 */
function digivate_test_panels_js()
{
    wp_enqueue_script( 'digivate-test-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
//add_action( 'customize_controls_enqueue_scripts', 'digivate_test_panels_js' );
