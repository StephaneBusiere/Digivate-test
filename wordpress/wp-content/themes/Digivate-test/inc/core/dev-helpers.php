 ...
 * @since Ignition 1.0
 */
function digivate_test_javascript_detection() {
...
add_action( 'wp_head', 'digivate_test_javascript_detection', 0 );
add_action( 'admin_head', 'digivate_test_javascript_detection', 0 );
