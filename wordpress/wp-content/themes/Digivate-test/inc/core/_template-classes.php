 ...
 * @return array
 */
function digivate_test_body_classes( $classes ) {
	...
	if ( is_customize_preview() ) {
		$classes[] = 'digivate-test-customizer';
	}

	// Add class on front page.
	if ( is_front_page() && 'posts' !== get_option( 'show_on_front' ) ) {
		$classes[] = 'digivate-test-front-page';
	}
...
add_filter( 'body_class', 'digivate_test_body_classes' );
